  ...
  methods: {
    async getAllData() {
      ...
      $.ajax({
        ...
        // url: "http://192.168.43.63:9235/pub/sceneData/场景1",
        url: "http://localhost:18000/data/scene1.json",
        // url: baseURL + "/pub/sceneData/场景1",
        data: "",
        dataType: "json",
    ...
    getMeterDetail(eqNo, title1, title2) {
      ...
      $.ajax({
        type: "post",
        url: baseURL + "/pub/equipment/场景1/" + eqNo,
        //url: "http://zjyum.cn:9235/pub/equipment/场景1/"+ eqNo,
        data: "",
        dataType: "json",
        success: function (res) {
          //清空原始数据
